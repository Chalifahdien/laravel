...
@section('content')
    ...
    <div class="page-body">
        <div class="container-xl">
            ...
            <form action="{{ route('admin.banner-promo.update', $bannerPromo) }}" method="POST" enctype="multipart/form-data" class="card">
                @csrf
                @method('PUT')
                    ...
                    <div class="row row-cards">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" class="form-control" value="{{ old('title', $bannerPromo->title) }}" placeholder="Promo title" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Link (optional)</label>
                                <input type="url" name="link" class="form-control" value="{{ old('link', $bannerPromo->link) }}" placeholder="https://...">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $bannerPromo->image) }}" alt="{{ $bannerPromo->title }}" class="img-fluid rounded" style="max-height: 120px;">
                                </div>
                                <label class="form-label">Replace Image (optional)</label>
                                <input type="file" name="image" class="form-control" accept="image/jpeg,image/jpg,image/png,image/gif,image/webp">
                                <small class="form-hint">Leave empty to keep current. JPG, PNG, GIF, WebP. Max 5MB.</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Sort Order</label>
                                <input type="number" name="sort_order" class="form-control" value="{{ old('sort_order', $bannerPromo->sort_order) }}" min="0">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                    ...
                                    @forelse ($machines as $machine)
                                        <div class="col-md-6 col-lg-4">
                                            <label class="form-check">
                                                <input class="form-check-input" type="checkbox" name="machine_ids[]" value="{{ $machine->id }}"
                        ...
                        <div class="col-12">
                            <label class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="is_active" value="1" {{ old('is_active', $bannerPromo->is_active) ? 'checked' : '' }}>
