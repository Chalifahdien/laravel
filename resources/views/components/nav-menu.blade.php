<ul class="navbar-nav px-1 dropdown-menu my-1 z-1">
    ...
    <a class="nav-link mb-1  {{ Request::is(patterns: 'stickers*') ? 'aktif' : '' }}" href="/stickers">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
    ...
    <a class="nav-link mb-1  {{ Request::is(patterns: 'settings-system*') ? 'aktif' : '' }}"
        href="{{ route('admin.settings.system.edit') }}">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
